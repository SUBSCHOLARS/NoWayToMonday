...
using UnityEngine;
using TMPro; // TextMeshProを使用するためにこの行を追加します
...
public class TypingEffectController : MonoBehaviour
{
    ...
    [SerializeField]
    private TextMeshPro textMeshPro2; // 下に配置したTextMeshProオブジェクト
    ...
    private IEnumerator AnimateTextRoutine()
    {
        ...
        while (true)
        {
            ...
            // 2つ目のテキストを1文字ずつ表示
            yield return StartCoroutine(ShowTextOneByOne(textMeshPro2));
            ...
            textMeshPro2.maxVisibleCharacters = 0;
